...
static const int iaMapsLevel[NUM_MAPS]
{
	1,										//0						Acasia Forest				
	1,										//1						Bamboo Forest				
	1,										//2						Garden of Freedom			
	1,										//3						Ricarten Town				
	1,										//4						Refuge of the Ancients		
	1,										//5						Castle of the Lost			
	1,                                      //6						Ruinen Village				
	1,                                      //7						Cursed Land					
	1,                                      //8						Forgotten Land				
	1,                                      //9						Navisko Town					
	1,                                      //10					Oasis						
	55,                                     //11					Battlefield of the Ancients	
	55,                                     //12					Forbidden Land				
	40,                                     //13					Ancient Prison 1F			
	50,                                     //14					Ancient Prison 2F			
	60,                                     //15					Ancient Prison 3F			
	1,                                      //16					Checker (GM) Room			
	1,                                      //17					Forest of Spirits			
	1,                                      //18					Land of Dusk					
	1,                                      //19					Valley of Tranquility		
	1,                                      //20					Road to the Wind				
	1,                                      //21					Phillai Town					
	70,                                     //22					Cursed Temple 1F				
	75,                                     //23					Cursed Temple 2F				
	55,                                     //24					Cave of Mushrooms			
	55,                                     //25					Cave of Beehive				
	65,                                     //26					Sanctuary of Darkness		
	80,                                     //27					Railway of Chaos				
	85,                                     //28					Heart of Perum				
	90,                                     //29					Eura							
	1,                                      //30					Bellatra Celestial			
	90,                                     //31					Gallubia Valley				
	1,                                      //32					Tier 4 Arena					
	80,                                     //33					Bless Castle					
	70,										//34					Greedy Lake					
	95,                                     //35					Frozen Temple				
	...
	105,									//38					Lost Temple					
	1,                                      //39					Ghost Castle					
	110,									//40					Endless Tower 1F				
	115,									//41					Endless Tower 2F				
	200,									//42					Cursed Temple 3F				
	120,									//43					Endless Tower 3F				
	200,									//44 (128 old)			Ice Mine 1F					
	200,                                    //45					Atlantis Town				
	200,                                    //46					Mystery Forest 1				
	200,                                    //47					Mystery Forest 2				
	200,                                    //48					Mystery Forest 3				
	200,									//49					Battle Town					
	200,									//50					Mystery Desert 3				
	200,									//51					Mystery Desert 2				
	200,                                    //52					Mystery Desert 1				
	200,									//53					Forgotten Temple 1			
	200,									//54					Forgotten Temple 2			
	200,									//55					Ancient Dungeon 1			
	200,									//56					Ancient Dungeon 2			
	200,									//57					Ancient Dungeon 3			
	200,									//58					Ancient Weapon				
	200,									//59					Abyss of the Sea				
	80,										//60					T5 Quest Arena				
	200,									//61 (136 old)			Secret Laboratory			
	80,										//62					Distorted Forest				
	80,										//63					Swamp						
	70,									//64					Old Ruinen 2					
	200,									//65					Death Island					
	100,									//66					Royal Desert					
	1,										//67					Forest Dungeon				
	1,										//68					Dragons Dungeon				
	200,									//69					Cursed Desert				
	200,									//70					Iron Core					
	100,									//71					Oasis Royale					
};
...
public:
	...
	void									AddStaticModel( const char * pszName, int iAnimationBip = 0 );
...
static int GetMapLevel( int i ) 
{ 
	if ( i < 0 || i >= _countof( iaMapsLevel ) )
		return 200;

	return iaMapsLevel[i];
};
...
struct StageObject3D
{
	EXEModel		* pcBoneModel;
	EXEModel		* pcModel;

	Point3D			sPosition;
	Point3D			sAngle;

	StageObject3D	* pcParent;
	
	int				iSum;

	UINT			dwLastRenderedTime;
};

class StageObject
{
	StageObject3D	* pcaObjectsMap[256][256];
	StageObject3D	saObjects[1024];
