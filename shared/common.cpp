...
bool AddDaysToSystemTime( SYSTEMTIME & sSystemTime, int iDays )
{
	if ( iDays == 0 )
		return true;
	...
	ULARGE_INTEGER sULarge;
	sULarge.LowPart = sFileTime.dwLowDateTime;
	sULarge.HighPart = sFileTime.dwHighDateTime;

	sULarge.QuadPart += (UINT64)iDays * 24 * 60 * 60 * 10000000;

	sFileTime.dwLowDateTime = sULarge.LowPart;
	sFileTime.dwHighDateTime = sULarge.HighPart;
