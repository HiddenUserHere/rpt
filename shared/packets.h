...
#define SERVER_LEVEL_MAX				130

#define DISTANCE_UNIT_FAR				0x12C000
#define DISTANCE_UNIT_TOO_FAR			0x320000
...
enum PacketsHeader
{
	...
	PKTHDR_SetBlackList								= 0x48470033,
	PKTHDR_SetItemCopyHack							= 0x48470034,
	...
	PKTHDR_QuestSkillStepUpdate						= 0x50320D00,
	...
	PKTHDR_PersonalShopOfflineCharacterData			= 0x48478AD1,
	...
	PKTHDR_RequestInitialData						= 0x4848FFFE,
	...
	//PKTHDR_NewPlayerSkipQuests						= 0x6A6A002E,
...
struct PacketCreateCharacter : Packet
{
	...
	PacketCreateCharacter( const char * pszAccountName, const char * pszCharacterName )
	{
		iUnknown = 0;
		iCode = 0;
		iUnk = 0;
		STRINGCOPY( szUserID, pszAccountName );
		STRINGCOPY( szCharname, pszCharacterName );
	};
	
	~PacketCreateCharacter() {};
};
...
struct PacketDeleteCharacter : Packet
{
	...
	PacketDeleteCharacter( const char * pszAccountName, const char * pszCharacterName )
	{
		STRINGCOPY( szUserID, pszAccountName );
		STRINGCOPY( szCharname, pszCharacterName );
	};
...
enum ELogCheat
{
	...
	CHEATLOGID_WeightPotionPositionError	= 1900,
	...
	CHEATLOGID_AntiCheatOffline				= 8996,
	CHEATLOGID_CharacterSaveChecksumError	= 8997,
	CHEATLOGID_SavingUnkownReturn			= 8998,	
	CHEATLOGID_ModelFileNotFound			= 8999,
