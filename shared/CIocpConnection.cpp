...
CIocpConnection::CIocpConnection( SOCKET _s, INT64 _iID, UINT _iBufferSize, const FNetConnectionInfo _sConnectionInfo ) :
    ...
    sConnectionInfo( _sConnectionInfo ), bReceivedFirstPacket( false )
{
}
