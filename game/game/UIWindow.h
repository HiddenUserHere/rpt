...
public:
	...
	void									ToggleCanMove() { SetCanMove( !bCanMove ); }
	...
	void									SetBeforeRenderChildrenEvent( int iEvent ) { iBeforeRenderChildrenEvent = iEvent; }
	...
	void									SetRenderBackgroundWhenHover( BOOL b ) { bRenderBackgroundWhenHover = b; }
...
private:
	...
	int										iEventID		= -1;
	int										iHoverEventID	= -1;
	int										iBeforeRenderChildrenEvent = -1;
	...
	BOOL									bRenderBackgroundWhenHover = FALSE;
