...
public:
    ...
    static int                                          GetCastleLeaderClanID() { return READINT( pfnBlessCastleClanID ); }
	static void											SetCastleLeaderClanID( int iClanID );
	...
	static BOOL 									    SetBlessCastleMasterClanID( int iClanID, int iUnkown = 0 );

	static BOOL											UpdateCrown( int iClanID );
	static BOOL											UpdateUnitDataCrown( UnitData * pcUnitData, int iClanID );
