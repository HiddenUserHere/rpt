...
#define IP_FORTRESS_WORLD		"192.95.21.20"
//#define IP_FORTRESS_BETA		"199.192.207.155" //"74.122.192.116"
#define IP_FORTRESS_BETA		"158.69.144.28" //"74.122.192.116"
...
#define MAX_ITEM_STAGE_GAME 8192
...
static void __cdecl SetPlayerPattern( UnitData * Player, const char * szModelFile, const char * szModelFile2 )
{
	typedef int( __cdecl *t_SetPlayerPattern ) ( UnitData *, const char *, const char * );
...
#define CHARACTER_CAMERAMODE				(*(int*)0x035E11D4)
#define CAMERA_MOVE_STEP					(8<<8)
#define FIELDGAME							((BaseMap**)0x00CF4748)

#define SHOW_INITIAL_PET					(*(BOOL*)0x035E085C)
#define INITIAL_PET_ELEMENT					(*(int*)0x035E0860)

#define QUEST_GLOBAL_FLAG					(*(int*)0x0362BA68)

#define QUEST_GLOBAL_ELEMENTARY_FLAG		(*(int*)0x035BF408)

#define LAST_QUESTSAVE_INFO_OLD				((LastQuestSave*)0x020BE520)

#define BLESSCASTLE_TAX_RATE				(*(int*)0x0363C0B8)	
...
#define ITEMVIEW_AUTO_FOLLOW				(*(DropItemView**)0x00CF48A8)
...
#define ISMOUSERIGHT_CLICKED				(*(BOOL*)0x00A1756C)
...
#define ITEMINDEX_INVENTORY					(*(int*)0x35EB65C)
