...
void CSettingsWindow::Load()
{
	...
	// Screen
	{
		...
		pCheckBoxAutoAdjust->SetSelected( SETTINGSHANDLER->GetModel()->GetSettings().bAutoAdjust );

		auto pCheckBoxStartMaximized = pWindowVideo->GetElement<UI::CheckBox>( CHECKBOXID_StartMaximized );
		pCheckBoxStartMaximized->SetSelected( SETTINGSHANDLER->GetModel()->GetSettings().bStartMaximized );
	...
	// BG Music
	{
		...
		{
			pCheckBoxNoMusic->SetSelected( TRUE );
		}
		else
		{
			pCheckBoxNoMusic->SetSelected( FALSE );
		}
	...
	// Effect iSound
	{
		...
		{
			pCheckBoxNoEffects->SetSelected( TRUE );
		}
		else
		{
			pCheckBoxNoEffects->SetSelected( FALSE );
		}
	...
	// Macro
	{
		...
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_NoWhisper )->SetSelected( SETTINGSHANDLER->GetModel()->GetSettings().bNoWhisper );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_NoTrade )->SetSelected( SETTINGSHANDLER->GetModel()->GetSettings().bNoTradeChat );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_DisableParty )->SetSelected( SETTINGSHANDLER->GetModel()->GetSettings().bNoPartyRequest );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_DisableTrade )->SetSelected( SETTINGSHANDLER->GetModel()->GetSettings().bNoTradeRequest );
	}
	...
	//Personalization
	{
		...
		auto pGroupConnectionData = pWindowGeneral->GetElement<UI::Group>( GROUPID_ConnectionData );
		if ( SETTINGSHANDLER->GetModel()->GetSettings().bShowConnectionData )
			pGroupConnectionData->SetIndexObject( CHECKBOXID_ConnectionDataON );
		else
			pGroupConnectionData->SetIndexObject( CHECKBOXID_ConnectionDataOFF );

		//Loot
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootFilterEnable )->SetSelected( SETTINGSHANDLER->GetModel()->GetSettings().bEnableLootFilter );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootHPPotion )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_HPPotion ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootMPPotion )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_MPPotion ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSPPotion )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_SPPotion ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootGold )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_Gold ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootAmulets )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_Amulets ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootRings )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_Rings ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSheltoms )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_Sheltoms ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootForceOrbs )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_ForceOrbs ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootPremiums )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_Premiums ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootMonsterCrystals )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_MonsterCrystals ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootDefenseItems )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_DefenseItems ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootOffenseItems )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_OffenseItems ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootEverything )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLoot( LOOTFILTER_Everything ) );

		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecNS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_NS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecFS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_FS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecMS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_MS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecAS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_AS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecPS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_PS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecATA )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_ATA ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecKS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_KS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecMGS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_MGS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecPRS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_PRS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecASS )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_ASS ) );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecSHA )->SetSelected( SETTINGSHANDLER->GetModel()->CanViewLootSpec( LOOTFILTERSPEC_SHA ) );
	}
	...
	//		pCheckBoxSaveUI->SetSelected( TRUE );
		...
		if( SETTINGSHANDLER->GetModel()->GetSettings().bShowPartyMembers )
			pCheckBoxShowParty->SetSelected( TRUE );
		...
		if( SETTINGSHANDLER->GetModel()->GetSettings().bShowRaidMembers )
			pCheckBoxShowRaid->SetSelected( TRUE );
		...
		if( SETTINGSHANDLER->GetModel()->GetSettings().bShowClanMembers )
			pCheckBoxShowClan->SetSelected( TRUE );
		...
		if( SETTINGSHANDLER->GetModel()->GetSettings().bShowEnemies )
			pCheckBoxShowEnemies->SetSelected( TRUE );
		...
		if( SETTINGSHANDLER->GetModel()->GetSettings().bShowNPCs )
			pCheckBoxShowNPCs->SetSelected( TRUE );
		...
		if( SETTINGSHANDLER->GetModel()->GetSettings().bMinimapAlwaysActive )
			pCheckBoxShowAlwaysActive->SetSelected( TRUE );
		...
		if( SETTINGSHANDLER->GetModel()->GetSettings().bShowNextBossTimer )
			pCheckBoxShowNextBossTimer->SetSelected( TRUE );
		...
		if( SETTINGSHANDLER->GetModel()->GetSettings().bShowNotice )
			pCheckBoxShowNotice->SetSelected( TRUE );
		...
		if ( SETTINGSHANDLER->GetModel()->GetSettings().bTargetHPPercent )
			pCheckBoxTargetHPPercent->SetSelected( TRUE );
	}
}
...
void CSettingsWindow::Save()
{
	...
	//Personalization
	{
		...
		auto pGroupConnectionData = pWindowGeneral->GetElement<UI::Group>( GROUPID_ConnectionData );
		SETTINGSHANDLER->GetModel()->GetSettings().bShowConnectionData = pGroupConnectionData->GetIndexObject() == CHECKBOXID_ConnectionDataON ? TRUE : FALSE;
...
{
	pWindowMenu->SetPosition( 699, GRAPHICENGINE->GetHeightBackBuffer() - 96 - 32 );
...
void CSettingsWindow::OnResetButtonClick( UIEventArgs eArgs )
{
	...
	{
		auto pCheckBoxAutoAdjust = pWindowVideo->GetElement<UI::CheckBox>( CHECKBOXID_AutoAdjust );
		pCheckBoxAutoAdjust->SetSelected( TRUE );

		auto pCheckBoxStartMaximized = pWindowVideo->GetElement<UI::CheckBox>( CHECKBOXID_StartMaximized );
		pCheckBoxStartMaximized->SetSelected( TRUE );
	...
	//Personalization
	{
		...
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootFilterEnable )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootHPPotion )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootMPPotion )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSPPotion )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootGold )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootAmulets )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootRings )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSheltoms )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootForceOrbs )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootPremiums )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootMonsterCrystals )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootDefenseItems )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootOffenseItems )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootEverything )->SetSelected( TRUE );

		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecNS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecFS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecMS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecAS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecPS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecATA )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecKS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecMGS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecPRS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecASS )->SetSelected( TRUE );
		pWindowGeneral->GetElement<UI::CheckBox>( CHECKBOXID_LootSpecSHA )->SetSelected( TRUE );
	...
	//	pCheckBoxSaveUI->SetSelected( TRUE );
		...
		pCheckBoxShowEnemies->SetSelected( TRUE );
		pCheckBoxShowNPCs->SetSelected( TRUE );
		pCheckBoxAlwaysActive->SetSelected( TRUE );
		pCheckBoxShowRaid->SetSelected( TRUE );
		pCheckBoxNextBossTimer->SetSelected( TRUE );
		pCheckBoxShowNotice->SetSelected( TRUE );
		pCheckBoxTargetDistance->SetSelected( TRUE );
		pCheckBoxTargetHPValue->SetSelected( TRUE );
		pCheckBoxTargetHPPercent->SetSelected( TRUE );
...
void CSettingsWindow::BuildWindow1General()
{
	...
	// Text
	UI::Text_ptr pTextConnectionData = std::make_shared<UI::Text>( Rectangle2D( 24, 287, 0, 16 ) );
	pTextConnectionData->SetFont( "Arial", 16, 0, FALSE, TRUE, -1 );
	pTextConnectionData->SetText( "Connection Data:" );
	pTextConnectionData->SetWidth( pTextConnectionData->GetTextWidth() + 8 );
	pWindowGeneral->AddElement( pTextConnectionData );

	// Group
	UI::Group_ptr pGroupConnectionData = std::make_shared<UI::Group>();
	pGroupConnectionData->SetID( GROUPID_ConnectionData );
	pWindowGeneral->AddElement( pGroupConnectionData );

	UI::CheckBox_ptr pCheckBoxConnectionDataON = std::make_shared<UI::CheckBox>( Rectangle2D( 24, 307, 13, 13 ) );
	pCheckBoxConnectionDataON->SetFont( "Arial", 16, 6, FALSE, FALSE, -1 );
	pCheckBoxConnectionDataON->SetText( "ON" );
	pCheckBoxConnectionDataON->SetGroup( pGroupConnectionData );
	pCheckBoxConnectionDataON->SetID( CHECKBOXID_ConnectionDataON );
	pCheckBoxConnectionDataON->SetImage( UI::ImageLoader::LoadImage( "game\\images\\UI\\checkbox.png" ), UI::ImageLoader::LoadImage( "game\\images\\UI\\checkbox_.png" ) );
	pWindowGeneral->AddElement( pCheckBoxConnectionDataON );

	UI::CheckBox_ptr pCheckBoxConnectionDataOFF = std::make_shared<UI::CheckBox>( Rectangle2D( 112, 307, 13, 13 ) );
	pCheckBoxConnectionDataOFF->SetFont( "Arial", 16, 6, FALSE, FALSE, -1 );
	pCheckBoxConnectionDataOFF->SetText( "OFF" );
	pCheckBoxConnectionDataOFF->SetGroup( pGroupConnectionData );
	pCheckBoxConnectionDataOFF->SetID( CHECKBOXID_ConnectionDataOFF );
	pCheckBoxConnectionDataOFF->SetImage( UI::ImageLoader::LoadImage( "game\\images\\UI\\checkbox.png" ), UI::ImageLoader::LoadImage( "game\\images\\UI\\checkbox_.png" ) );
	pWindowGeneral->AddElement( pCheckBoxConnectionDataOFF );
