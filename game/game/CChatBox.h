...
private:
	...
	void							OnMessageClick( UI::Text_ptr pTextMessage, EChatColor eChatColor, UIEventArgs eArgs );

	std::string						GetPlayerName( std::string strMessage );

	std::string						GetPlayerNameReceived( std::string strMessage, EChatColor eChatColor );
