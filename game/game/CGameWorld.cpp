...
BOOL CGameWorld::Init()
{
	...
	ULONG ulFPTLocal	= inet_addr( "127.0.0.1" );
	...
	vWorlds.push_back( new CWorld( WORLDID_TestLocal, "TestLocal", ulFPTLocal, 10009, "TestPT", "tPT", "FortressPT.net", ulFPTLocal, ulFPTLocal ) );
