...
protected:
	...
	IMPFNC						pfnOnMouseRClickDown		= 0x004C3CE0;
	...
	IMPFNC						pfnChangeCostumeSetFlag		= 0x035EB690;
	IMPFNC						pfnCostumeInventoryOpenFlag = 0x03625718;
...
public:
	...
	static BOOL					GetIsChangeCostumeSet() { return READINT( pfnChangeCostumeSetFlag ); }
	static void					SetIsChangeCostumeSet( BOOL b ) { WRITEINT( pfnChangeCostumeSetFlag, b ); }

	static BOOL					GetIsCostumeInventoryOpen() { return READINT( pfnCostumeInventoryOpenFlag ); }
	static void					SetCostumeInventoryOpen( BOOL b ) { WRITEINT( pfnCostumeInventoryOpenFlag, b ); }

	int							CheckMousePotionCount();
	void						OnMouseLDownClick( int iX, int iY );
	
	void						OnMouseRDownClick( int iX, int iY );
