...
#define STARTERCOREHANDLER					(GAMECORE->GetStarterCoreHandler())
...
#define ACTIONBARHANDLER					(GAMECORE->GetActionBarHandler())
...
public:
	...
	static void	WINAPI							SendRequestInitialData( bool bLoginServer );
...
public:
	...
	CStarterCoreHandler									* pcStarterCoreHandler = NULL;
	...
	CActionBarHandler									* pcActionBarHandler = NULL;
	...
	CStarterCoreHandler									* GetStarterCoreHandler() { return pcStarterCoreHandler; }
	...
	CActionBarHandler									* GetActionBarHandler() { return pcActionBarHandler; }
};