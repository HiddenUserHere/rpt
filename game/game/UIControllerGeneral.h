...
protected:
	...
	CCharacterStatusWindowHandler				* pcCharacterStatusWindowHandler = nullptr;

	float										fAutoSkillTimeRotation = 0.0f;

	UI::Image									* pcSkillAutobar = nullptr;
...
public:
	...
	CCharacterStatusWindowHandler				* GetCharacterStatusWindow() { return pcCharacterStatusWindowHandler; }
};
