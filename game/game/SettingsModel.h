...
enum EWindowSizeStateChange
{
	WINDOWSIZESTATECHANGE_None,
	WINDOWSIZESTATECHANGE_Minimized,
	WINDOWSIZESTATECHANGE_Maximized,
	WINDOWSIZESTATECHANGE_Restored,
};
...
public:
	...
	void												OnWindowSizeChange( EWindowSizeStateChange eState, UINT uWidth, UINT uHeight );
