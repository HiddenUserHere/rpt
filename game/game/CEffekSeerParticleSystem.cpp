...
CEffekSeerParticleSystem::CEffekSeerParticleSystem( Effekseer::EffectRef _pcEffect ) : pcEffect( _pcEffect )
{
...
void CEffekSeerParticleSystem::Render( Effekseer::ManagerRef pcManager, BOOL bBack )
{
	if ( bKill )
		return;
