...
void CTradeHandler::Init()
{
	...
	UI::Button_ptr pButtonTradeCheckSelf = std::make_shared<UI::Button>( Rectangle2D( 300, 212, 26, 26 ) );
	...
	UI::ImageBox_ptr pImageTradeCheckUnitOff = std::make_shared<UI::ImageBox>( Rectangle2D( 300, 124, 26, 26 ) );
	...
	UI::ImageBox_ptr pImageTradeCheckUnit = std::make_shared<UI::ImageBox>( Rectangle2D( 300, 124, 26, 26 ) );
