...
public:
	...
	void									SetShowColorBox( BOOL b ) { bShowColorBox = b; }

	void									SetOverrideBoxSize( BOOL b, int iWidth = 0, int iHeight = 0 ) { bOverrideBoxSize = b; iOverridedBoxWidth = iWidth; iOverridedBoxHeight = iHeight; }

private:

	BOOL									IsAllowedItem( ItemData * pcItemData );

	BOOL									GetCollision( ItemData * pcItemData, int iX, int iY, int iMouseX, int iMouseY, int & iPlaceX, int & iPlaceY, int & iItemX, int & iItemY, int & iItemWidth, int & iItemHeight );
	...
	BOOL									bOverrideBoxSize = FALSE;
	int										iOverridedBoxWidth = 0;
	int										iOverridedBoxHeight = 0;
