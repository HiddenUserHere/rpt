...
public:
	...
	static struct EXEModelData * ReadInx( const char * pszFile );
	...
	static void					AddStageLoader( Stage * pcStage, const std::string strStageName );
	...
	static void					SetNewHardwareID( const char * pszNewHardwareID );
	static char					* GetNewHardwareID() { return szNewHardwareID; }
...
private:
	...
	static char					szNewHardwareID[40];
