...
public:
	...
	void									SetAdditionalEvent( int iEventID, EMouseEvent e = EMouseEvent::ClickDownR ) { iAdditionalEventID = iEventID; eAdditionalMouseEvent = e; }
	...
	void									SetOnHoverInEvent( int iEventID ) { iOnHoverEventID = iEventID; }			
	void									SetOnHoverOutEvent( int iEventID ) { iOnHoverOutEventID = iEventID; }

	void									FireEvent() { if ( iEventID != -1 ) UI::Event::Invoke( iEventID ); }
...
private:
	...
	enum EMouseEvent						eAdditionalMouseEvent = EMouseEvent::ClickDownR;
	...
	int										iOnHoverEventID = -1;
	int										iOnHoverOutEventID = -1;
