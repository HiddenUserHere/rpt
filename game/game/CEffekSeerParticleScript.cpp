...
CEffekSeerParticleScript::CEffekSeerParticleScript( const std::string _strName, Effekseer::EffectRef _pcEffect ) : strFileName( _strName ), pcEffect( _pcEffect )
{
	bCache = TRUE;
...
void CEffekSeerParticleScript::SetRotateToView( bool b )
{
	for ( auto pcParticleSystem : vParticleSystems )
		pcParticleSystem->SetRotateToView( b );
}