...
BOOL EXERender::SetCameraPosition( int iX, int iY, int iZ, int iAX, int iAY, int iAZ )
{
	...
	{
		sCameraPos.iX = (int)(GRAPHICS->GetRenderer()->GetCamera()->Eye().x * 256.f);
		sCameraPos.iY = (int)(GRAPHICS->GetRenderer()->GetCamera()->Eye().y * 256.f);
		sCameraPos.iZ = (int)(GRAPHICS->GetRenderer()->GetCamera()->Eye().z * 256.f);
	}
	...
	if( (GAMESCREEN->GetActiveScreenType() == SCREEN_Character) || (GAMESCREEN->GetActiveScreenType() == SCREEN_Login) )
	{
		...
		sCameraM.i[0][0] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._11 * 2048.f);
		sCameraM.i[0][1] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._12 * 2048.f);
		sCameraM.i[0][2] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._13 * 2048.f);
		sCameraM.i[0][3] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._14 * 2048.f);
		sCameraM.i[1][0] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._21 * 2048.f);
		sCameraM.i[1][1] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._22 * 2048.f);
		sCameraM.i[1][2] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._23 * 2048.f);
		sCameraM.i[1][3] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._24 * 2048.f);
		sCameraM.i[2][0] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._31 * 2048.f);
		sCameraM.i[2][1] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._32 * 2048.f);
		sCameraM.i[2][2] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._33 * 2048.f);
		sCameraM.i[2][3] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._34 * 2048.f);
		sCameraM.i[3][0] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._41 * 2048.f);
		sCameraM.i[3][1] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._42 * 2048.f);
		sCameraM.i[3][2] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._43 * 2048.f);
		sCameraM.i[3][3] =  (int)(GRAPHICS->GetRenderer()->GetCamera()->View()._44 * 2048.f);
	}
