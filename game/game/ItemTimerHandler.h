...
public:
	ItemTimer( EItemTimerType iType, EItemID iItemID, const char * pszName, const char * pszDescription, DWORD dwTimeLeft, DWORD dwTimeTotal, UI::Image * pcImage, UI::Image * pcImageBackground );
	virtual ~ItemTimer();
