...
public:
	...
	static BOOL									SQLGetCharacter( const std::string strCharacterName, SQLCharacter * ps );
	...
	void										SetExpOnCharacterData( CharacterData & sCharacterData, INT64 iExp );

	INT64										GetExpFromLevel( int iLevel );

	INT64										GetExpFromCharacterData( const CharacterData & sCharacterData );
	...
	void										GetCharacterWeaponShieldID( const char * pszCharacterName, int & iWeaponID, int & iShieldID );
	...
	const char									* GetServerName( User * pcUser );
	...
	int											SQLGetCharacterID( const char * pszName );
	...
	static BOOL									IsValidCharacterData(CharacterData * psCharacterData );

	DWORD										GetHashString( const char * pszName );

	static DWORD								GetHashCharacterDataOld( CharacterData * psCharacterData );
};
