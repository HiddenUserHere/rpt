...
BOOL HookAPI( const char* moduleName, const char* apiName, void* callBack, void* backup = NULL )
{
	DWORD old;
...
void Launch()
{
	...
	CreateProcessA( NULL, (LPSTR)"""server.exe""", NULL, NULL, FALSE, NORMAL_PRIORITY_CLASS, NULL, NULL, &s, &p );
}

extern "C" int __stdcall WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
	//HookOperatorsNewDelete();
