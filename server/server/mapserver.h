...
public:
	...
	void									ProcessPacket( UserData * pcUserData, PacketStageItemData * psPacket );
	...
	static UnitData							* SpawnSubMonster( UnitData * pcUnitDataMaster, int iMonsterEffectID, int iX, int iY, int iZ, int iMaxMonstersOnSpawn );
	...
	void									SQLUpdateBossTimeBotDB( int iMinute, int iServerID, int iDay );
