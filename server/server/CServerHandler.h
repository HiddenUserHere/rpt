...
#define CHARACTERDATAHANDLER			(SERVERHANDLER->GetCharacterDataHandler())
...
{
private:
	CCharacterDataHandler		* pcCharacterDataHandler;
...
public:
	...
	CCharacterDataHandler		* GetCharacterDataHandler() { return pcCharacterDataHandler; }
