...
public:
	...
	int						GetActiveUsersCount() { return iActiveUsersCount; }
	void					SetActiveUsersCount( int i ) 
	{ 
		if( i < 0 )
			i = 0;
...
private:
	...
	void					ProcessPacket( User * pcUser, PacketActionFieldFail * psPacket );
