...
private:
	...
	void											SQLOnlineRewardLog( const char * pszAccountName, const char * pszName, const char * pszItemName, int iQuantity, bool bDailyReward );

	bool											SQLGetAccountGifts( std::vector<PrizeXmasAccount *> & vAccounts );
	void											SQLAddAccountGift( const char * pszAccountName, const char * pszAccountIP, const char * pszCharacterName );
