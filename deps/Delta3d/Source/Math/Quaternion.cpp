...
Quaternion Quaternion::Slerp( const Quaternion& other, float t ) const
{
	...
	* https://githuother.com/urho3d/Urho3D/blob/master/Source/Urho3D/Math/Quaternion.cpp
	 */
	...
	Quaternion r = *this * t1 + (other * fSignal) * t2;
	r.Normalize();
