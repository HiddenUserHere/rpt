...
void Frustum::DefineOrtho( float orthoSize, float aspectRatio, float zoom, float nearClip, float farClip )
{
	nearDistance = nearClip;
	farDistance = farClip;
	...
	farHeight = nearHeight = halfViewSize;
	farWidth = nearWidth = nearHeight * aspectRatio;
}
