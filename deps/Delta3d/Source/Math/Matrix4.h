...
public:
	...
	Matrix4 operator *( float fv ) const;
	...
	Matrix4 Transpose() const
	{
		...
		_mm_storeu_ps( &out._21, m2 );
		_mm_storeu_ps( &out._31, m1 );
	...
	bool Decompose( Vector3 & vScale, Quaternion & vRotation, Vector3 & vTranslation );
