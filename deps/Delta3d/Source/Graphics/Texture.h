...
public:
	...
	//Set an external Texture Decrypter
	static void SetExternalDecrypter( std::function<int( char *, int, const char * )> f );
private:
	/**
...
private:
	...
	//! Decrypt External
	static std::function<int( char *, int, const char * )>	fDecryptExternal;
};
